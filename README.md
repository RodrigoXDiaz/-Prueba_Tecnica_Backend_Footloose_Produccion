...
Este proyecto está optimizado para desplegarse en **Render** con configuración automatizada.
...
- ✅ `PRODUCTION.md` - Checklist y documentación de producción
...
4. **Configura variables de entorno** (ver `.env.production`)
   - `NODE_ENV=production`
   - `PORT=10000`
...
📖 Lee la guía completa de despliegue en **[DEPLOYMENT.md](./DEPLOYMENT.md)**
